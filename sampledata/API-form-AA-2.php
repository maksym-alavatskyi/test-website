...
<h1 align="center">FORM A to page A with API (sent with Form name argument)</h1>

<p>If first name = tomer  form can't be submitted succesfully = ClickTaleRegisterFormSubmitFailure(form)</p>
...
<script type="text/javascript">
    ...
    function TestClick() {
        ...
        alert(document.forms.demo.telnr.value);
    }
    ...
    function formSubmit(form) {
        ...
        if (valid) {
			...
			if (document.forms.demo.from.value == 'tomer') {
				
				if (typeof ClickTaleRegisterFormSubmitFailure == "function")
					ClickTaleRegisterFormSubmitFailure(form);
				alert('!!! FORM was NOT Successefully Submitted');
				return false;
			}
			else {
				...
				alert('FORM was Successefully Submitted');	
				return true;
			}
            ...
            // ct: submit not sent
			if (typeof ClickTaleRegisterFormSubmitNotSent== "function")
     ...
     <br /><br />
     <div id="myDivEl" align="center" >
      
     </div>
<br /><br />
<form name="demo" action="" onsubmit="return formSubmit(this) "  method="GET"  >
<table class="formtab" summary="Demonstration form" bgcolor="#CCFFFF" frame="border">
  <tr>
...
<!-- Note: the element to receive error messages must contain some data (for most, 
  ...
  <tr>
    ...
    <td bgcolor="#FF5050"><input type="submit" name="Submit" value="Submit" style="width: 214px"/></td>
    <!--<td bgcolor="#FF5050"><input type="button" name="Submit" value="Button" style="width: 214px" onClick="TestClick()" /></td>-->
