...
<div id="container"> 
  ...
  <div id="wrapper">
		...
		<h1 align="center">FORM A to page A with API</h1>
...
//        if (errs == 1) alert('There is a field which needs correction before sending');
	   ...
	   //alert("check all");
        ...
        if (params.length > 1) {
            ...
            if (params[0].split('=')[1]=='tomer') {
                ...
                //if (formSubmit(form)
                document.getElementById("myDivEl").innerHTML = "FORM was submission failed";
    ...
    function formSubmit(form) {
     ...
     <br /><br />
     <div id="myDivEl" align="center" style="background-color: #00FFFF">
