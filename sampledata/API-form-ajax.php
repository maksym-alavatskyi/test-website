...
<h1>Ajax page with Api</h1>

<!--
<div id="myDiv"><h2>Let AJAX change this text</h2></div>
<button type="button" onclick="loadXMLDoc()">Change Content</button>
-->
<p>if first name = tomer form cant't be submmitted succefully in server side. 
</p>
    ...
    function CheckSubmit() {
        ...
        if (params.length > 1) {
            ...
            if (params[0].split('=')[1] == 'tomer') {
               ...
               // ClickTaleRegisterFormSubmitFailed();
       ...
       if (window.XMLHttpRequest) {// code for IE7+, Firefox, Chrome, Opera, Safari
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                if (document.getElementById("from").value == 'tomer') {
                    if (typeof ClickTaleRegisterFormSubmitFailure == "function")
                        ClickTaleRegisterFormSubmitFailure(form);

                    document.getElementById("myDiv").innerHTML = 'Was not submitted becouse server side validation failed';
                }
                else {
                ...
                //else
                //    document.getElementById("myDiv").innerHTML = "very bad";
                // TODO, declare success/failure
            }
        }
...
<form name="demo"  method="get" onsubmit = "validateOnSubmit(this); return false;"   action=""  >  
