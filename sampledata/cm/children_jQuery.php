...
<head>
    ...
    <script type="text/javascript">
        ...
        var replaceText = function (originalString) {
            //if (!!originalString && !isEmpty(originalString) && isBlank(originalString)) {
            if ((!!originalString) && !((/^\s*$/).test(originalString))) {
                return "This is the Escaped Text";
            }
            return originalString;
        };


        projectionFnArr.push(function (projection, sessionId, description) {
            //var tmpCount = projection.moved.count();
            //console.log("DDD " + tmpCount + " moved elements found");
            //if (tmpCount > 0) {
            //    for (var i = 0; i < tmpCount; ++i) {
            //        var currnode = projection.moved.getNode(i);
            //        var currSerializedNode = projection.moved.getProcessedNode(i);
            //        if (currnode === null)
            //            break;
            //        if (typeof currSerializedNode === 'string') {
            //            ;
            //        }
            //        else if (!!currSerializedNode.textContent)
            //            currSerializedNode.textContent = replaceText(currSerializedNode.textContent);
            //        else if (!!currSerializedNode.node && !!currSerializedNode.node.textContent)
            //            currSerializedNode.node.textContent = replaceText(currSerializedNode.node.textContent);
            //    }
            //}
            //tmpCount = projection.removed.count();
            //if (tmpCount > 0) {
            //    for (i = 0; i < tmpCount; ++i) {
            //        currnode = projection.removed.getNode(i);
            //        currSerializedNode = projection.removed.getProcessedNode(i);
            //        if (currnode === null)
            //            break;
            //        if (typeof currSerializedNode === 'string') {
            //            ;
            ...
            //    }
            //    console.log("DDD " + tmpCount + "  removed elements found");
            //}
            //tmpCount = projection.text.count();
            //if (tmpCount > 0) {
            //    for (i = 0; i < tmpCount; ++i) {
            //        currnode = projection.text.getNode(i);
            //        currSerializedNode = projection.text.getProcessedNode(i);
            //        if (currnode === null)
            //            break;
            //        if (typeof currSerializedNode === 'string') {
            //            ;
            ...
            //    console.log("DDD " + tmpCount + " removed elements found");
            //}
            //tmpCount = projection.attributes.count();
            //if (tmpCount > 0) {
            //    for (i = 0; i < tmpCount; ++i) {
            //        currnode = projection.attributes.getNode(i);
            //        currSerializedNode = projection.attributes.getProcessedNode(i);
            //        if (currnode === null)
            //            break;
            //        if (typeof currSerializedNode === 'string') {
            //            ;
        ...
        //window.ClickTaleSettings.Compression = { Method: "deflate" };
...
<body>
    ...
    <br />
    <br />
    <table cellpadding="20" border="1" width=width width="100%">
        <tr>
            <td valign="top">
                ...
                <button id="jQbyId_26" onclick="removeTextBetween2Texts()">(26) removeTextBetween2Texts</button>
                <button id="jQbyId_33" onclick="jQueryHTMLTest()">jQueryHTMLTest</button>
                ...
                <div id="doritdiv" class="wrapDiv">
                    <div id="doritdivInternal1" style="background: aquamarine ">Aqua Marine</div>
                </div>
            ...
            <td valign="top">
                ...
                <button id="jQbyClass_24" onclick="removeSingleText()">(24) remove single text()</button>
                <button id="jQbyClass_25" onclick="relocateSingleTextBefore()">(25) relocate single text Before</button>
