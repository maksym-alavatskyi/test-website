        ...
        <body>
        	...
        	<div id="jq">
        		...
        		<BR>
        			...
        			<option id="to_46" value="out_of_scope">out_of_scope</option>
        		</select>
...
<!-- move #<input type="text" name="from" value="" id="from">
	...
	<button id="scope_05" onclick="removeElm($('#from').val())">remove element of Move selection</button>
	<button id="scope_05" onclick="appendElm($('#from').val())">append element to Move selection</button><br>
	...
	<div id="out_of_scope" class="out_of_scope">
		<div id="d1"><h4></h4>
			...
			<div id="d2" class="ex"><h4></h4>
				<div class="el" id="el2"></div>	
			</div>

			<div id="d3" class="ex"><h4></h4>
				<div id="d4" ><h4></h4>
	...
	if (typeof jQuery != 'function') {
		...
		function appendElm(e1){
			e1 = "#"+e1;
			$(e1).append("<div class='el'>new</div>");
		}
	}
