                    ...
                    <div id="contact-form">
                        ...
                        <form id="fvujq-form1" method="post" action="" onsubmit="">
                            ...
                            <div class="form-row">
                                ...
                                <br>
                                <div class="form-row">
                                    <a class="button lime" id="vis_btn"> Toggle visibility <span></span></a>
                                    <br>
                                    <br>
                                ...
                                <div class="form-row" id="ajax_content">
                                    <a class="button light-brown" id="ajax_btn"> Add Dynamic Fields using Ajax <span></span></a>
                                    <br>
                                    <br>
                                </div>
                                <br>
