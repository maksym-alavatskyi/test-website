...
<?php } else if(0 === strpos($subdomain, 'cs-integration-lab')) { ?>
			...
			(function() {
			   ...
			   headElement.appendChild(mt);
			   console.log(headElement.children.length);
			})();
...
else if(0 === strpos($subdomain, 'next-stage31-tag03') && strpos($_SERVER[REQUEST_URI],"portfolio")>0) {
     header("Access-Control-Allow-Origin: *");
  ?>
			<script type="text/javascript">
			(function() {

         console.log("Loading integrity tag version 4")
			   var mt = document.createElement("script"); mt.type = "text/javascript"; mt.async = true;
         mt.integrity="sha512-c+erurTLNhDB2ZmSLsFbUvA30CbPSSb52Di+JUC16oy4Kh6i3vN2N0qUMLCXKyOFk1bCLdI4vnbSsAVsNALCOA==";
         mt.src="https://ct-staging.contentsquare.net/ss/1913/3b3f48af-da86-490b-a775-6c6acc418548/4/uxa.js";
         mt.setAttribute("crossorigin", "anonymous")
...
else if(0 === strpos($subdomain, 'next-stage31-tag03')) {
     header("Access-Control-Allow-Origin: *");
  ?>
			<script type="text/javascript">
			(function() {

         console.log("Loading integrity tag version 1")
			   var mt = document.createElement("script"); mt.type = "text/javascript"; mt.async = true;
         mt.integrity="sha512-qG5ZcjNjU5DBY2meXh9pKDRw1Zcgyw2x8m1fgW0maPPA0v6L/iKJeAnx/TnICMTCQd5pqjcE9iJ/1iZuWTgYFw==";
         mt.src="https://ct-staging.contentsquare.net/ss/1913/3b3f48af-da86-490b-a775-6c6acc418548/1/uxa.js";
         mt.setAttribute("crossorigin", "anonymous")
...
<?php }
      ...
      <?php if(0 === strpos($subdomain, 'cs-test-01') || 0 === strpos($subdomain, 'cs-stage-next-cloud-a') || 0 === strpos($subdomain, 'cs-stage-next-cloud-b')){ ?>
