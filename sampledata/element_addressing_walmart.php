            ...
            <div class=leftNavBox>
              <div class=roundedBoxMenuCol4>
                <div class=boxImage style="top:0px; left:560px; width:227px;">
                  <a  onClick="return doNothing" href="#!" >
                    <img height=460 width=227 src="http://i3.walmartimages.com/images/Site/Categories/HomePage/2013/Week47/1220/0329.png">
                  </a>
                </div>
                <div class=boxColumn>
            ...
            <div class=leftNavBox>
              <div class=roundedBoxMenuCol4>
                <div class=boxImage style="top:0px; left:560px; width:203px;">
                  <a  onClick="return doNothing" href="#!" >
                    <img height=379 width=203 src="http://i3.walmartimages.com/images/Site/2014/Week11/28423-49249_home_flyout.png">
                  </a>
                </div>
                <div class=boxColumn>
      ...
      <article class="span24 subContainerRow clearfix" style="height:41px;margin-top:5px; margin-bottom:-20px; margin-left:auto; margin-right:auto;">
        <article class="span24 wm2upProducts">
          <div class=parentPositionDiv>
            ...
            <!-- End Fix for UserStory PGSHP-88 -->
            <img height=60 usemap="#spotLightmap-40" width=1012 src="http://i3.walmartimages.com/images/Site/Categories/HomePage/2013/Week50/0111/8690-53853_March_posteaster_header.png">
          </div>
          <!-- SHOP002-spotLightClickableAreaContainer -->
        </article>
      </article>
        ...
        <article class="wm2UpProducts ">
          <div class=parentPositionDiv>
            ...
            <a  onClick="return doNothing" href="#!"  title="Shop Air Conditioners & Fans">
              <img height=225 usemap="#spotLightmap-62" width=495 src="http://i3.walmartimages.com/images/Site/2014/Week13/29451-55764_May_Coolingy_dblspot.png">
            </a>
          </div>
    ...
    <section class=container>
      ...
      <section class=span15>
        ...
        <article class="span4 padding-none">
          ...
          <div id=gFooterSpotLight class="gFooterColumn footerLinks">
            <ul class=ftlink>
              <li>
                <span class=showmore>
                  [+]
