...
<h2>HM (short page) - elements with name/id/none attributes + DIV BEFORE TABLE </h2>

<div id="divActivites" name="divActivites" style="border:1px solid black;background-color: #00FFEE;"> Additional DIV</div> 
<br>
