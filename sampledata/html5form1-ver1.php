...
<meta charset="UTF-8">
<title>ClickTale | Testing Portal | fields added to the main form </title>
	...
	<!-- BEGIN captcha theme-->
 	...
 	<!-- END captcha theme-->
		...
		<div class="left">
			...
			<h3>Field Confirm email added to the main form.</h3>
			...
			<form id="form1" action="verify.php" method="POST">
				...
				<legend>Personal Details</legend>
					<label>First Name ( autofocus ):</label>
						<input name="fname" type="text" autofocus /><br/>
					...
					<label>Confirm Email:</label>
						<input name="confirmEMail" type="email" required /><br/>
...
<script type="text/javascript">
	$(function(){
		if(typeof ClickTaleEvent=="function")
			...
			ClickTaleEvent("html5_form-ver1");
		})();
  </script>
<!-- Begin Footer -->
