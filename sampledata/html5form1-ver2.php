...
<meta charset="UTF-8">
<title>ClickTale | Testing Portal | fields added to the small form </title>
	...
	<!-- BEGIN captcha theme-->
 	...
 	<!-- END captcha theme-->
		...
		<div class="left">
			...
			<h3>Field Confirm email added to the small form.</h3>
			...
			<form id="form1" action="verify.php" method="POST">
				...
				<legend>Personal Details</legend>
					<label>First Name ( placeholder):</label>
						<input name="fname" type="text" placeholder="Please enter your name"  /><br/>
						...
						<form action="/login.php" method="POST">
								...
								<div class="form-row">
									<div class="form-field">
										<input id="login" name="username" type="text" placeholder="Please enter your username" required/>
									</div>
									<div class="form-field">
										<input id="pwd" name="password" type="text" placeholder="Please enter your password" required/>
									</div>
									<div class="form-field">
										<input id="confirmPwd" name="password_confirmation" type="text" placeholder="Please re-enter your password" required/>
									</div>
								</div>
...
<script type="text/javascript">
	$(function(){
		 if(typeof ClickTaleEvent=="function")
			...
			ClickTaleEvent("html5_form-ver2");
	})();
  </script>
<!-- Begin Footer -->
