...
<meta charset="UTF-8">
<title>ClickTale | Testing Portal | ClickTale HTML5 dynamically displayed field </title>
  ...
  <div id="wrapper">
	...
	<!-- BEGIN captcha theme-->
 	...
 	<!-- END captcha theme-->
		...
		<div class="left">
			<h1>HTML5 - hidden fields displayed dynamically</h1>
			...
			<form id="form1" action="verify.php" method="POST">
				...
				<button id="show-dates">Display Date and Time fields</button>
				<fieldset id="date-and-time" style="display: none;">
				...
				<fieldset>
					<legend>Show hidden fields</legend>
					<span>Confirm your account</span><br/>
					<input type="radio" name="confirmOpt" value="byEmail" id="emailConfirm"/> By Email <div id="emailForConfirmation" style="display:none;"><input type="email" name="emailForConfirmation" placeholder="Enter confrmation email address" /></div><br/>
					<input type="radio" name="confirmOpt" value="bySms" id="smsConfirm"/> By Sms &nbsp;<div id="telForConfirmation" style="display:none;"><input type="tel" name="telForConfirmation" placeholder="Enter confrmation phone number"/></div><br/>
					...
					<form>
							...
							<div class="form-row">
								<div class="form-field">
									<input id="login" type="email" placeholder="Please enter your email" required/>
								</div>
								<div class="form-field">
									<input id="pwd" type="password" placeholder="Please enter your password" required/>
								</div>
...
<script type="text/javascript">
					$(function(){
						$('#emailConfirm').click(function(){
							...
							if($(this).is(':checked'))
							{
								$("#emailForConfirmation").show();
								$("#telForConfirmation").hide();
							}
						});
						...
						$('#smsConfirm').click(function(){
							if($(this).is(':checked'))
							{
								$("#telForConfirmation").show();
								$("#emailForConfirmation").hide();
							}
						});
						
						$('#show-dates').click(function(){
							$('#date-and-time').toggle();
							if($(this).text()=="Display Date and Time fields")
								$(this).text("Hide Date and Time fields");
							else 
								$(this).text("Display Date and Time fields");
						});
					});
</script>
<!-- Set Clicktale Tag -->
  <script type="text/javascript">
    $(function(){ if(typeof ClickTaleEvent=="function")
        ClickTaleEvent("html5_form");
		ClickTaleEvent("html5_form-dynamic_ver1");
		})();
  </script>
<!-- Begin Footer -->
