...
<meta charset="UTF-8">
<title>ClickTale | Testing Portal | HTML5 dynamically added field </title>
  ...
  <div id="wrapper">
	...
	<!-- BEGIN captcha theme-->
 	...
 	<!-- END captcha theme-->
		...
		<div class="left">
			<h1>HTML5 fields added dynamically with javascript</h1>
			...
			<form id="form1" action="verify.php" method="POST">
				...
				<fieldset>
					<legend>Add field based on selection</legend>
					<span>Confirm your account</span><br/>
					<input type="radio" name="confirmOpt" value="byEmail" id="emailConfirm"/> By Email <div id="emailForConfirmation"></div><br/>
					<input type="radio" name="confirmOpt" value="bySms" id="smsConfirm"/> By Sms &nbsp;<div id="telForConfirmation"></div><br/>
...
<script type="text/javascript">
     $(function(){
		if(typeof ClickTaleEvent=="function")
			...
			ClickTaleEvent("html5_form-dynamic_ver2");
			})();
  </script>
<!-- Begin Footer -->
