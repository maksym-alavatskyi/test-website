...
<meta charset="UTF-8">
<title>Contensquare | Testing Portal | Home</title>
...
$(function() {
		if(location.hostname.split('.').shift()==="cs-adobe-1"){
		   loadAdobeEvarTag();
		}
...
<script>
function loadAdobeEvarTag(){
 console.log("Loading Adobe Evar");
}
</script>
<script>
...
<div id="container" style=display: block;>
  ...
  <div id="cycle-wrapper">
    <div id="sliderholder-cycle"> <img src="style/images/art/slider-1.jpg" width="960" height="380" />
      <div>
        <iframe src="https://www.contentsquare.com" width="960" height="700" frameborder="0"></iframe>
      </div>
  ...
  <div id="wrapper">
    ...
    <div class="intro">
      <h1> Reveal your visitors' mouse moves, clicks, and scorlls with In-Page Web Analytics.
					...
					<input type="button" id="mybut2" value="js Error" >
<input type="button" id="mybut3" value="WR js Error" ">
    </div>
    <!-- End Intro -->
    ...
    <div class="tab-wrapper">
      <ul id="tab-menu">
        <li class="selected" id="tab-menu-item1"><img src="style/images/icon-palette.png" alt="" /> Session Playback</li>
        <li id="tab-menu-item2"><img src="style/images/icon-art.png" alt="" /> Heatmaps</li>
        <li id="tab-menu-item3"><img src="style/images/icon-laptop.png" alt="" /> Link Analytics</li>
        <li id="tab-menu-item4"><img src="style/images/icon-camera.png" alt="" /> Form Analytics</li>
      </ul>
  ...
  <div class="push"></div>
  <div id="errorBtns" class="homeErrorBtns" style="text-align: center;">
		<h1>My Errors</h1>
			<div>
			...
			<div>
				<a onclick="sendFetchError()" id="btn7" class="linkBtn" style="background-color:red;">Error API1</a>
			</div>
			<div>
				<a onclick="sendFetchError()" id="btn8" class="linkBtn" style="background-color:red;">Error API2</a>
			</div>
			<div>
				<a onclick="sendXhrError()" id="btn9" class="linkBtn" style="background-color:red;">Error API3</a>
			</div>
			<div>
				<a onclick="sendXhrError()" id="btn10" class="linkBtn" style="background-color:red;">Error API4</a>
			</div>
			<div>
				<a onclick="myErrors(this)" id="script error" class="linkBtn"style="background-color:black;">script error</a>
			</div>
			<div>
				<a onclick="myErrors(this)" id="script error ." class="linkBtn"style="background-color:black;">script error .</a>
			</div>
