...
<meta charset="UTF-8">
<title>ClickTale | Testing Portal | Insights | Page C </title>
  ...
  <div id="wrapper">
    <div class="content">
      <div class="tabbed-content">
		...
		<a id="goal_link" href="page-e-aftergoal.php">go to page with goal</a>
...
<script type="text/javascript">
		...
		$('#goal_link').click(function(e){	
				
				console.log('link clicked');
				if (typeof ClickTale == "function"){
					
					ClickTaleEvent("goal_clicked");
				}
		});
