  ...
  <div id="wrapper">
    <div class="content">
			<div id="errorBtns" style="text-align: center;">
				...
				<div class="errApiDiv">
					<div  class="errBtnDiv1">
						<a onclick="typeError(this)" id="btn12" class="linkBtn">Error API 1</a>
					</div>
					<div  class="errBtnDiv">
						<a onclick="referenceError(this)" id="btn13" class="linkBtn">Error API 2</a>
					</div>
					<div  class="errBtnDiv">
						<a onclick="rangeError(this)" id="btn14" class="linkBtn">Error API 3</a>
					</div>
					<div  class="errBtnDiv">
						<a onclick="externalError()" id="btn15" class="linkBtn">Error API 4</a>
					</div>
				</div>
			</div>
		</div>
