...
<div id="container"> 
  ...
  <div id="wrapper">
    <div class="content">
         <div id="extra" style="padding:20px; border: 1px solid red;"> Extra div for testing</div>
      <div class="tabbed-content">
        ...
        <div class="tab_container">
          ...
          <div style="display: none;" id="tab2_1" class="tab_content">
            <h3>We love tabs</h3>
            <p><img src="style/images/art/portfolio4-th.jpg" class="right" />Etiam molestie, risus eu gravida lobortis, velit sapien aliquam lectus, nec hendrerit lectus erat ac libero.
