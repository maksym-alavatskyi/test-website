...
<input type="hidden" name="isNew" value="true">
  ...
  <fieldset>
    <div class="field">
      ...
      <select name="country" id="country" class="required">
        <option value="" id="dd0">- Select -</option>
        <option value="se" id="dd1">Iran</option>
		<option value="no" id="dd2">Israel</option>
		<option value="se" id="dd3">Micronesia</option>
        <option value="se" id="dd4">Narnia</option>	
  ...
  <div class="field radio">
		...
		<ul class="inputs">
       <li>
			<input type="radio" name="smoking" value="Regularly" class="required" title="Please choose an option" id="smoking1">
			<span>Regularly </span>
		</li>
		<li>
			<input type="radio" name="smoking" value="Sometimes" checked="checked" id="smoking2">
			<span>Sometimes </span>
		</li>
		<li>
			<input type="radio" name="smoking" value="No" id="smoking3">
			<span>No </span>
		</li>
		</ul>
      </div>
  ...
  <div class="field radio">
		...
		<ul class="inputs">
       <li>
			<input type="radio" name="alcohol" value="Regularly" id="drinking1">
			<span>Regularly </span>
		</li>
		<li>
			<input type="radio" name="alcohol" value="Sometimes" id="drinking2">
			<span>Sometimes </span>
		</li>
		<li>
			<input type="radio" name="alcohol" value="No" id="drinking3">
			<span>No </span>
		</li>
		</ul>
      </div>
