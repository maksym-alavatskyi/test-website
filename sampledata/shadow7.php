...
<div id="container">
  ...
  <div id="wrapper">
    <div class="content">
      <h2>Shadow7</h2>
      <p>bla </p>
	  <div id="shadowHost1">Don't display this</div>
...
<?php
  ...
  <script>
	var shadowHost = document.querySelector('#shadowHost1');
	...
	root.innerHTML = `<style>h3{ color: yellow; } .myButton {	background-color:#44c767; border-radius:28px; border:1px solid #18ab29;	display:inline-block;
          ...
          .content{ padding: 5px; background-color:#f0f0f0; }
					 ...
					 `<h3>Shadow DOM</h3>`+
					 `<p>
            <a href="shadow1.php" class="myButton">Click Me!</a>
            <div>
           ...
           `<div class="content">
            ...
            var host2 = root.querySelector('#shadowHost2');
            ...
            root2.innerHTML = `<style>h3{ color: red; } .myButton {	background-color:#black; border-radius:28px; border:1px solid #18ab29;	display:inline-block;
                    ...
                    .content{ padding: 5px; background-color:#f0f0f0; }
          					 ...
          					 `<h3>Shadow DOM</h3>` +
          					 `<p>
                      <a href="shadow2.php" class="myButton">Click Me2!</a>
                    </p>`;
