...
<meta charset="UTF-8">
<title>Background Page Testing Page - Version 3</title>
...
<div id="container"> 
  ...
  <div id="wrapper"> 
    ...
    <!-- Begin Content -->
    <div class="content">
      <h3>Background Page Testing Page - Version 3</h3>
      ...
      <div class="contact-left">
        <div id="contact-form"> 
          ...
          <div id="note"></div>
          <!--begin:notice message block-->
	<button onclick='ClickTaleEvent("Event_1")'>Event_1</button>
	<button onclick='alert(error_event)'>JS Error</button>
	<button onclick='ClickTaleSetCustomElementID()'>Clicktale Error</button>
		   
<div id="extra" style="padding:20px; border: 1px solid red;"> Extra div for testing Form Analytics</div>
      ...
      <div class="contact-right">
        ...
        <div class="one-half">
          ...
          <p>2 Shoham st.<br />
            ...
            <span class="highlight3">Tel:</span> 1 800 807 2118 <br />
			<a href="http://www.clicktale.com/jobs">Career</a>
			</p>
        </div>
        <div class="one-half last">
          ...
          <p>Moon Avenue No:11/21 <br />
            ...
            <span class="highlight3">Tel:</span> +555 636 646 62 <br />
			Website:<a href="http://clicktale.com/"> clicktale.com</a>
			</p>
        </div>
        <div class="clear"></div>
        <br />
		...
		<br /><br /><a href="http://clicka/">Clicka</a>
		...
		<br /><button onclick='ClickTaleEvent("Event_2")'>Event_2</button>
		<br /><img src="/style/images/art/portfolio16-th.jpg" />
		</div>
      <div class="clear"></div>
	...
	$('#check1').click(function(){
			...
			$(function() {
				if (typeof ClickTale == "function"){
					...
					ClickTaleEvent("div-before-form");
				}
			})
</script>
<script type="text/javascript">
